...
const MODULE_SCHEMAS = {
  inventory: {
    ...
    aliases: { sku: ['sku','SKU','code','Code','Kod'], name: ['name','Name','item','Item','Product','Məhsul','family','Family'], category: ['category','Category','Kateqoriya','family','Family'], warehouse: ['warehouse','Warehouse','Anbar','wh'], qty: ['qty','Qty','quantity','Quantity','Miqdar','stock','Stock'], minStock: ['minStock','min','Min','minimum'], maxStock: ['maxStock','max','Max','maximum'], unitCost: ['unitCost','cost','Cost','price','Price','Qiymət','unit_cost','unitPrice'], unit: ['unit','Unit','Vahid'], location: ['location','Location','Yer'], supplier: ['supplier','Supplier','Təchizatçı'], status: ['status','Status','Vəziyyət'] },
  ...
  suppliers: {
    ...
    aliases: { name: ['name','Name','Supplier','supplier','Təchizatçı','company','Company'], category: ['category','Category','Kateqoriya','type','Type'], country: ['country','Country','Ölkə'], contact: ['contact','Contact','Əlaqə','person','Person'], email: ['email','Email','e-mail','E-mail'], phone: ['phone','Phone','Telefon','tel','Tel'], status: ['status','Status','Vəziyyət'], score: ['score','Score','Rating','rating','Bal'], onTimeRate: ['onTimeRate','onTime','on_time','delivery_rate'], spend: ['spend','Spend','total','Total','Xərc'] },
  ...
  purchaseOrders: {
    ...
    aliases: { supplier: ['supplier','Supplier','Təchizatçı','vendor','Vendor'], total: ['total','Total','Cəm','amount','Amount'], status: ['status','Status','Vəziyyət'], priority: ['priority','Priority','Prioritet'], delivery: ['delivery','Delivery','deliveryDate','eta','ETA','Çatdırılma'], category: ['category','Category','Kateqoriya'], notes: ['notes','Notes','Qeyd','comment','Comment'] },
  ...
  salesOrders: {
    ...
    aliases: { customer: ['customer','Customer','Müştəri','client','Client'], total: ['total','Total','Cəm','amount','Amount'], status: ['status','Status'], priority: ['priority','Priority'], deliveryDate: ['deliveryDate','delivery','Delivery','Çatdırılma'], paymentStatus: ['paymentStatus','payment','Payment','Ödəniş'], notes: ['notes','Notes','Qeyd'] },
